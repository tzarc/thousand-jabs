...
actions+=/chaos_strike,if=(!talent.momentum.enabled|buff.momentum.up|fury.deficit<=30+buff.prepared.up*8)&!variable.pooling_for_meta&(!talent.demonic.enabled|!cooldown.eye_beam.ready)
...
actions.cooldown+=/potion,name=old_war,if=buff.metamorphosis.remains>25
]]
