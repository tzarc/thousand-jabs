...
internal.apls["legion-dev::Tier19P::Rogue_Assassination_Exsg_T19P"] = [[
...
actions+=/rupture,cycle_targets=1,if=combo_points>=cp_max_spend&refreshable&target.time_to_die-remains>4
...
actions+=/envenom,if=(!talent.exsanguinate.enabled|cooldown.exsanguinate.remains>2)&!dot.rupture.refreshable&active_dot.rupture>=spell_targets.fan_of_knives&((!talent.elaborate_planning.enabled&combo_points>=cp_max_spend)|(talent.elaborate_planning.enabled&combo_points>=3&buff.elaborate_planning.remains<2))
...
actions+=/fan_of_knives,if=spell_targets>2|buff.the_dreadlords_deceit.stack>=29
actions+=/mutilate
...
internal.apls["legion-dev::Tier19H::Rogue_Assassination_Exsg_T19H"] = [[
actions.precombat=flask,name=flask_of_the_seventh_demon
actions.precombat+=/augmentation,name=defiled
actions.precombat+=/food,name=seedbattered_fish_plate
actions.precombat+=/snapshot_stats
