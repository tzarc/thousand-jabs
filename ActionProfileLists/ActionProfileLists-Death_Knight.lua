...
actions.icytalons+=/frost_strike,if=talent.breath_of_sindragosa.enabled&cooldown.breath_of_sindragosa.remains>15&!talent.frozen_pulse.enabled
actions.icytalons+=/frost_strike,if=!talent.breath_of_sindragosa.enabled&!talent.frozen_pulse.enabled
actions.icytalons+=/frost_strike,if=buff.icy_talons.remains<1.5|buff.icy_talons.stack<3&talent.frostscythe.enabled
actions.icytalons+=/frost_strike,if=!talent.frostscythe.enabled
