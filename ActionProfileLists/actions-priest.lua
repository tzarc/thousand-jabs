...
---- active_enemies
---- auspicious_spirits.talent_enabled
---- bloodlust.spell_remains
---- current_insanity_drain
---- fortress_of_the_mind.talent_enabled
---- gcd
---- gcd.max
---- insanity.curr
---- insanity_drain_stacks.spell_stack
---- legacy_of_the_void.talent_enabled
---- mass_hysteria.artifact_rank
---- mind_blast.spell_usable_in
---- mind_spike.talent_enabled
---- mindbender.talent_enabled
---- nonexecute_actors_percent
---- power_infusion.spell_remains
---- raw_haste_percent
---- reaper_of_souls.talent_enabled
---- sanlayn.talent_enabled
---- set_bonus.tier18_2pc
---- shadow_crash.talent_enabled
---- shadow_word_death.cooldown_charges
---- shadow_word_death.cooldown_remains
---- shadow_word_pain.spell_remains
---- shadow_word_pain.spell_ticking
---- shadowform.spell_remains
---- shadowy_apparitions_in_flight
---- shadowy_insight.spell_remains
---- shadowy_insight.talent_enabled
---- sphere_of_insanity.artifact_rank
---- surrender_to_madness.spell_remains
---- surrender_to_madness.talent_enabled
---- target.time_to_die
---- time
---- unleash_the_shadows.artifact_rank
---- vampiric_touch.spell_remains
---- vampiric_touch.spell_ticking
---- variable.actors_fight_time_mod
---- variable.s2mcheck
---- void_bolt.cooldown_remains
---- void_bolt.spell_usable
---- void_bolt.spell_usable_in
---- void_torrent.cooldown_remains
---- voidform.spell_remains
...
internal.actions['legion-dev::priest::shadow'] = {
    default = {
        {
            ...
            condition_converted = '(((bloodlust.spell_remains_as_number > 0)) or (((((target.time_to_die_as_number) <= (40))) or ((((((voidform.spell_stack_as_number) > (80))) and ((power_infusion.spell_remains_as_number > 0))))))))',
            condition_keywords = {
                'bloodlust.spell_remains',
                'power_infusion.spell_remains',
                'target.time_to_die',
        ...
        },
        {
            ...
            condition_converted = '(((((time_as_number + target.time_to_die_as_number)) > (450))) and ((((time_as_number + target.time_to_die_as_number)) < (600))))',
            condition_keywords = {
                'target.time_to_die',
                'time',
            },
            ...
            value_converted = ' - (((( - (450) + (time_as_number + target.time_to_die_as_number))) / 10))',
            value_keywords = {
                'target.time_to_die',
                'time',
            },
        },
        {
            ...
            condition_converted = '(((time_as_number + target.time_to_die_as_number)) <= (450))',
            condition_keywords = {
                'target.time_to_die',
                'time',
            },
            ...
            value_converted = '((((450 - (time_as_number + target.time_to_die_as_number))) / 5))',
            value_keywords = {
                'target.time_to_die',
                'time',
            },
        },
        {
            ...
            value_converted = '((0.8 * ((135 + (((raw_haste_percent_as_number * 25) * ((2 + (1 * reaper_of_souls.talent_enabled_as_number) + (2 * mass_hysteria.artifact_rank_as_number) - (1 * sanlayn.talent_enabled_as_number)))))))) - (variable.actors_fight_time_mod_as_number * nonexecute_actors_percent_as_number))',
            value_keywords = {
                'mass_hysteria.artifact_rank',
                'nonexecute_actors_percent',
                'raw_haste_percent',
        ...
        },
        {
            ...
            condition_converted = '(((voidform.spell_remains_as_number > 0)) and ((surrender_to_madness.spell_remains_as_number > 0)))',
            condition_keywords = {
                'surrender_to_madness.spell_remains',
                'voidform.spell_remains',
            },
        ...
        },
        {
            ...
            condition_converted = '(voidform.spell_remains_as_number > 0)',
            condition_keywords = {
                'voidform.spell_remains',
            },
            name = 'vf',
    ...
    main = {
        {
            ...
            condition_converted = '((surrender_to_madness.talent_enabled) and (((target.time_to_die_as_number) <= (variable.s2mcheck_as_number))))',
            condition_keywords = {
                'surrender_to_madness.talent_enabled',
                'target.time_to_die',
                'variable.s2mcheck',
        ...
        },
        {
            ...
            condition_converted = '((mindbender.talent_enabled) and ((not surrender_to_madness.talent_enabled)))',
            condition_keywords = {
                'mindbender.talent_enabled',
                'surrender_to_madness.talent_enabled',
            },
        ...
        },
        {
            ...
            condition_converted = '((mindbender.talent_enabled) and (((surrender_to_madness.talent_enabled) and (((target.time_to_die_as_number) > ((variable.s2mcheck_as_number + 60)))))))',
            condition_keywords = {
                'mindbender.talent_enabled',
                'surrender_to_madness.talent_enabled',
                'target.time_to_die',
        ...
        },
        {
            ...
            condition_converted = '((shadow_word_pain.spell_remains_as_number) < ((((3 + (4 / 3))) * gcd_as_number)))',
            condition_keywords = {
                'gcd',
                'shadow_word_pain.spell_remains',
            },
        ...
        },
        {
            ...
            condition_converted = '((vampiric_touch.spell_remains_as_number) < ((((4 + (4 / 3))) * gcd_as_number)))',
            condition_keywords = {
                'gcd',
                'vampiric_touch.spell_remains',
            },
        ...
        },
        {
            ...
            condition_converted = '((((insanity.curr_as_number) >= (85))) or ((((auspicious_spirits.talent_enabled) and (((insanity.curr_as_number) >= (((80 - (shadowy_apparitions_in_flight_as_number * 4))))))))))',
            condition_keywords = {
                'auspicious_spirits.talent_enabled',
                'insanity.curr',
                'shadowy_apparitions_in_flight',
        ...
        },
        {
            ...
            condition_converted = 'shadow_crash.talent_enabled',
            condition_keywords = {
                'shadow_crash.talent_enabled',
            },
        ...
        },
        {
            ...
            condition_converted = '((mindbender.talent_enabled) and (set_bonus.tier18_2pc))',
            condition_keywords = {
                'mindbender.talent_enabled',
                'set_bonus.tier18_2pc',
            },
        ...
        },
        {
            ...
            condition_converted = '(((shadow_word_pain.spell_remains == 0)) and (((legacy_of_the_void.talent_enabled) and (((insanity.curr_as_number) >= (70))))))',
            condition_keywords = {
                'insanity.curr',
                'legacy_of_the_void.talent_enabled',
                'shadow_word_pain.spell_remains',
        ...
        },
        {
            action = 'vampiric_touch',
            condition = '!ticking&talent.legacy_of_the_void.enabled&insanity>=70',
            condition_converted = '(((vampiric_touch.spell_remains == 0)) and (((legacy_of_the_void.talent_enabled) and (((insanity.curr_as_number) >= (70))))))',
            condition_keywords = {
                'insanity.curr',
                'legacy_of_the_void.talent_enabled',
                'vampiric_touch.spell_remains',
        ...
        },
        {
            ...
            condition_converted = '(((not reaper_of_souls.talent_enabled)) and (((((shadow_word_death.cooldown_charges) == (2))) and (((insanity.curr_as_number) <= (90))))))',
            condition_keywords = {
                'insanity.curr',
                'reaper_of_souls.talent_enabled',
                'shadow_word_death.cooldown_charges',
        ...
        },
        {
            ...
            condition_converted = '((reaper_of_souls.talent_enabled) and (((((shadow_word_death.cooldown_charges) == (2))) and (((insanity.curr_as_number) <= (70))))))',
            condition_keywords = {
                'insanity.curr',
                'reaper_of_souls.talent_enabled',
                'shadow_word_death.cooldown_charges',
        ...
        },
        {
            ...
            condition_converted = '((legacy_of_the_void.talent_enabled) and ((((((insanity.curr_as_number) <= (81))) or ((((((insanity.curr_as_number) <= (75.2))) and (fortress_of_the_mind.talent_enabled))))))))',
            condition_keywords = {
                'fortress_of_the_mind.talent_enabled',
                'insanity.curr',
                'legacy_of_the_void.talent_enabled',
        ...
        },
        {
            ...
            condition_converted = '(((not legacy_of_the_void.talent_enabled)) or ((((((insanity.curr_as_number) <= (96))) or ((((((insanity.curr_as_number) <= (95.2))) and (fortress_of_the_mind.talent_enabled))))))))',
            condition_keywords = {
                'fortress_of_the_mind.talent_enabled',
                'insanity.curr',
                'legacy_of_the_void.talent_enabled',
        ...
        },
        {
            ...
            condition_converted = '(((shadow_word_pain.spell_remains == 0)) and (((((target.time_to_die_as_number) > (10))) and ((((((active_enemies_as_number) < (5))) and ((((auspicious_spirits.talent_enabled) or (shadowy_insight.talent_enabled))))))))))',
            condition_keywords = {
                'active_enemies',
                'auspicious_spirits.talent_enabled',
                'shadow_word_pain.spell_remains',
        ...
        },
        {
            ...
            condition_converted = '(((vampiric_touch.spell_remains == 0)) and (((((target.time_to_die_as_number) > (10))) and ((((((active_enemies_as_number) < (4))) or (((sanlayn.talent_enabled) or ((((auspicious_spirits.talent_enabled) and (unleash_the_shadows.artifact_rank))))))))))))',
            condition_keywords = {
                'active_enemies',
                'auspicious_spirits.talent_enabled',
                'sanlayn.talent_enabled',
        ...
        },
        {
            ...
            condition_converted = '(((shadow_word_pain.spell_remains == 0)) and (((((target.time_to_die_as_number) > (10))) and ((((((active_enemies_as_number) < (5))) and (sphere_of_insanity.artifact_rank)))))))',
            condition_keywords = {
                'active_enemies',
                'shadow_word_pain.spell_remains',
                'sphere_of_insanity.artifact_rank',
        ...
        },
        {
            ...
            condition_converted = '(((((((insanity.curr_as_number) <= (70))) and (legacy_of_the_void.talent_enabled)))) or ((((((insanity.curr_as_number) <= (85))) and ((not legacy_of_the_void.talent_enabled))))))',
            condition_keywords = {
                'insanity.curr',
                'legacy_of_the_void.talent_enabled',
            },
        ...
        },
        {
            ...
            condition_converted = '(((not mind_spike.talent_enabled)) and (((((active_enemies_as_number) >= (2))) and (((active_enemies_as_number) < (4))))))',
            condition_keywords = {
                'active_enemies',
                'mind_spike.talent_enabled',
            },
        ...
        },
        {
            ...
            condition_converted = '(not mind_spike.talent_enabled)',
            condition_keywords = {
                'mind_spike.talent_enabled',
            },
            interrupt = '1',
        ...
        },
        {
            action = 'mind_spike',
            condition = 'talent.mind_spike.enabled',
            condition_converted = 'mind_spike.talent_enabled',
            condition_keywords = {
                'mind_spike.talent_enabled',
            },
    ...
    precombat = {
        ...
        },
        {
            ...
            condition_converted = '(not ((shadowform.spell_remains_as_number > 0)))',
            condition_keywords = {
                'shadowform.spell_remains',
            },
    ...
    s2m = {
        ...
        },
        {
            ...
            condition_converted = 'mindbender.talent_enabled',
            condition_keywords = {
                'mindbender.talent_enabled',
            },
        ...
        },
        {
            ...
            condition_converted = '((((shadow_word_pain.spell_remains_as_number) > (5.5))) and (((vampiric_touch.spell_remains_as_number) > (5.5))))',
            condition_keywords = {
                'shadow_word_pain.spell_remains',
                'vampiric_touch.spell_remains',
            },
        ...
        },
        {
            ...
            condition_converted = '(((not reaper_of_souls.talent_enabled)) and ((((((current_insanity_drain_as_number * gcd.max_as_number)) > (insanity.curr_as_number))) and (((((((insanity.curr_as_number - (current_insanity_drain_as_number * gcd.max_as_number) + 15))) < (100))) and ((((not ((power_infusion.spell_remains_as_number > 0)))) and (((((insanity_drain_stacks.spell_stack_as_number) <= (77))) and (((shadow_word_death.cooldown_charges) == (2))))))))))))',
            condition_keywords = {
                'current_insanity_drain',
                'gcd.max',
                'insanity.curr',
        ...
        },
        {
            ...
            condition_converted = '((reaper_of_souls.talent_enabled) and ((((((current_insanity_drain_as_number * gcd.max_as_number)) > (insanity.curr_as_number))) and (((((((insanity.curr_as_number - (current_insanity_drain_as_number * gcd.max_as_number) + 65))) < (100))) and ((((not ((power_infusion.spell_remains_as_number > 0)))) and (((((insanity_drain_stacks.spell_stack_as_number) <= (77))) and (((shadow_word_death.cooldown_charges) == (2))))))))))))',
            condition_keywords = {
                'current_insanity_drain',
                'gcd.max',
                'insanity.curr',
        ...
        },
        {
            ...
            condition_converted = '((((shadow_word_pain.spell_remains_as_number) < ((3.5 * gcd_as_number)))) and (((((vampiric_touch.spell_remains_as_number) < ((3.5 * gcd_as_number)))) and (((target.time_to_die_as_number) > (10))))))',
            condition_keywords = {
                'gcd',
                'shadow_word_pain.spell_remains',
                'target.time_to_die',
        ...
        },
        {
            ...
            condition_converted = '((((shadow_word_pain.spell_remains_as_number) < ((3.5 * gcd_as_number)))) and ((((((auspicious_spirits.talent_enabled) or (shadowy_insight.talent_enabled)))) and (((target.time_to_die_as_number) > (10))))))',
            condition_keywords = {
                'auspicious_spirits.talent_enabled',
                'gcd',
                'shadow_word_pain.spell_remains',
        ...
        },
        {
            ...
            condition_converted = '((((vampiric_touch.spell_remains_as_number) < ((3.5 * gcd_as_number)))) and ((((((sanlayn.talent_enabled) or ((((auspicious_spirits.talent_enabled) and (unleash_the_shadows.artifact_rank))))))) and (((target.time_to_die_as_number) > (10))))))',
            condition_keywords = {
                'auspicious_spirits.talent_enabled',
                'gcd',
                'sanlayn.talent_enabled',
        ...
        },
        {
            ...
            condition_converted = '((((shadow_word_pain.spell_remains_as_number) < ((3.5 * gcd_as_number)))) and (((sphere_of_insanity.artifact_rank) and (((target.time_to_die_as_number) > (10))))))',
            condition_keywords = {
                'gcd',
                'shadow_word_pain.spell_remains',
                'sphere_of_insanity.artifact_rank',
        ...
        },
        {
            ...
            condition_converted = '(((not reaper_of_souls.talent_enabled)) and ((((((current_insanity_drain_as_number * gcd.max_as_number)) > (insanity.curr_as_number))) and (((((insanity.curr_as_number - (current_insanity_drain_as_number * gcd.max_as_number) + 15))) < (100))))))',
            condition_keywords = {
                'current_insanity_drain',
                'gcd.max',
                'insanity.curr',
        ...
        },
        {
            ...
            condition_converted = '((reaper_of_souls.talent_enabled) and ((((((current_insanity_drain_as_number * gcd.max_as_number)) > (insanity.curr_as_number))) and (((((insanity.curr_as_number - (current_insanity_drain_as_number * gcd.max_as_number) + 65))) < (100))))))',
            condition_keywords = {
                'current_insanity_drain',
                'gcd.max',
                'insanity.curr',
        ...
        },
        {
            ...
            condition_converted = '(((((current_insanity_drain_as_number * gcd.max_as_number)) > (insanity.curr_as_number))) and ((not ((power_infusion.spell_remains_as_number > 0)))))',
            condition_keywords = {
                'current_insanity_drain',
                'gcd.max',
                'insanity.curr',
        ...
        },
        {
            ...
            condition_converted = '(((shadow_word_pain.spell_remains == 0)) and ((((((active_enemies_as_number) < (5))) or (((auspicious_spirits.talent_enabled) or (((shadowy_insight.talent_enabled) or (sphere_of_insanity.artifact_rank)))))))))',
            condition_keywords = {
                'active_enemies',
                'auspicious_spirits.talent_enabled',
                'shadow_word_pain.spell_remains',
        ...
        },
        {
            ...
            condition_converted = '(((vampiric_touch.spell_remains == 0)) and ((((((active_enemies_as_number) < (4))) or (((sanlayn.talent_enabled) or ((((auspicious_spirits.talent_enabled) and (unleash_the_shadows.artifact_rank))))))))))',
            condition_keywords = {
                'active_enemies',
                'auspicious_spirits.talent_enabled',
                'sanlayn.talent_enabled',
    ...
    vf = {
        {
            ...
            condition_converted = '((surrender_to_madness.talent_enabled) and (((((insanity.curr_as_number) >= (25))) and (((((((void_bolt.cooldown_remains_as_number > 0)) or ((((void_torrent.cooldown_remains_as_number > 0)) or ((((shadow_word_death.cooldown_remains_as_number > 0)) or ((shadowy_insight.spell_remains_as_number > 0))))))))) and (((target.time_to_die_as_number) <= ((variable.s2mcheck_as_number - (insanity_drain_stacks.spell_stack_as_number))))))))))',
            condition_keywords = {
                'insanity.curr',
                'insanity_drain_stacks.spell_stack',
                'shadow_word_death.cooldown_remains',
        ...
        },
        {
            ...
            condition_converted = '((((shadow_word_pain.spell_remains_as_number) > (5.5))) and (((((vampiric_touch.spell_remains_as_number) > (5.5))) and (((surrender_to_madness.talent_enabled) and (((target.time_to_die_as_number) > ((variable.s2mcheck_as_number - (insanity_drain_stacks.spell_stack_as_number) + 60)))))))))',
            condition_keywords = {
                'insanity_drain_stacks.spell_stack',
                'shadow_word_pain.spell_remains',
                'surrender_to_madness.talent_enabled',
        ...
        },
        {
            ...
            condition_converted = '(not surrender_to_madness.talent_enabled)',
            condition_keywords = {
                'surrender_to_madness.talent_enabled',
            },
        ...
        },
        {
            ...
            condition_converted = '((mindbender.talent_enabled) and (((surrender_to_madness.talent_enabled) and (((target.time_to_die_as_number) > ((variable.s2mcheck_as_number - (insanity_drain_stacks.spell_stack_as_number) + 30)))))))',
            condition_keywords = {
                'insanity_drain_stacks.spell_stack',
                'mindbender.talent_enabled',
                'surrender_to_madness.talent_enabled',
        ...
        },
        {
            ...
            condition_converted = '((((voidform.spell_stack_as_number) >= (10))) and (((((insanity_drain_stacks.spell_stack_as_number) <= (30))) and ((not surrender_to_madness.talent_enabled)))))',
            condition_keywords = {
                'insanity_drain_stacks.spell_stack',
                'surrender_to_madness.talent_enabled',
                'voidform.spell_stack',
        ...
        },
        {
            ...
            condition_converted = '((((voidform.spell_stack_as_number) >= (10))) and (((surrender_to_madness.talent_enabled) and (((target.time_to_die_as_number) > ((variable.s2mcheck_as_number - (insanity_drain_stacks.spell_stack_as_number) + 25)))))))',
            condition_keywords = {
                'insanity_drain_stacks.spell_stack',
                'surrender_to_madness.talent_enabled',
                'target.time_to_die',
        ...
        },
        {
            ...
            condition_converted = '((((voidform.spell_stack_as_number) >= (10))) and (((((insanity_drain_stacks.spell_stack_as_number) <= (20))) and ((not surrender_to_madness.talent_enabled)))))',
            condition_keywords = {
                'insanity_drain_stacks.spell_stack',
                'surrender_to_madness.talent_enabled',
                'voidform.spell_stack',
        ...
        },
        {
            ...
            condition_converted = '((((voidform.spell_stack_as_number) >= (10))) and (((surrender_to_madness.talent_enabled) and (((target.time_to_die_as_number) > ((variable.s2mcheck_as_number - (insanity_drain_stacks.spell_stack_as_number) + 60)))))))',
            condition_keywords = {
                'insanity_drain_stacks.spell_stack',
                'surrender_to_madness.talent_enabled',
                'target.time_to_die',
        ...
        },
        {
            ...
            condition_converted = '(((not reaper_of_souls.talent_enabled)) and ((((((current_insanity_drain_as_number * gcd.max_as_number)) > (insanity.curr_as_number))) and (((((insanity.curr_as_number - (current_insanity_drain_as_number * gcd.max_as_number) + 10))) < (100))))))',
            condition_keywords = {
                'current_insanity_drain',
                'gcd.max',
                'insanity.curr',
        ...
        },
        {
            ...
            condition_converted = '((reaper_of_souls.talent_enabled) and ((((((current_insanity_drain_as_number * gcd.max_as_number)) > (insanity.curr_as_number))) and (((((insanity.curr_as_number - (current_insanity_drain_as_number * gcd.max_as_number) + 30))) < (100))))))',
            condition_keywords = {
                'current_insanity_drain',
                'gcd.max',
                'insanity.curr',
