...
actions.main=surrender_to_madness,if=talent.surrender_to_madness.enabled&0.8*(target.time_to_die<=45+((raw_haste_pct*100)*(2+(1*talent.reaper_of_souls.enabled)+(2*artifact.mass_hysteria.rank))))
