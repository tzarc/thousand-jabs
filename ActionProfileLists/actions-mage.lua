...
actions.standard_rotation+=/pyroblast,if=buff.hot_streak.react&target.health.pct<=25&equipped.132454
actions.standard_rotation+=/pyroblast,if=buff.kaelthas_ultimate_ability.react
