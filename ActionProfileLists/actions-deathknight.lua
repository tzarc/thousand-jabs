...
actions+=/call_action_list,name=gs_ticking,if=talent.gathering_storm.enabled&buff.remorseless_winter.remains
...
actions.bos+=/remorseless_winter,if=(buff.rime.react&equipped.132459)|talent.gathering_storm.enabled
...
actions.bos_ticking+=/remorseless_winter,if=((runic_power>=20&set_bonus.tier19_4pc)|runic_power>=30)&((buff.rime.react&!dot.hungering_rune_weapon.ticking&equipped.132459)|talent.gathering_storm.enabled)
actions.bos_ticking+=/howling_blast,if=((runic_power>=20&set_bonus.tier19_4pc)|runic_power>=30)&buff.rime.react&!dot.hungering_rune_weapon.ticking
...
actions.generic+=/horn_of_winter,if=!dot.hungering_rune_weapon.ticking
...
actions.gs_ticking+=/horn_of_winter,if=runic_power<70&!dot.hungering_rune_weapon.ticking
actions.gs_ticking+=/glacial_advance
actions.gs_ticking+=/frost_strike
actions.gs_ticking+=/hungering_rune_weapon,if=!dot.hungering_rune_weapon.ticking
actions.gs_ticking+=/empower_rune_weapon
]]
