...
internal.apls["legion-dev::Tier19P::Warlock_Demonology_T19P"] = [[
actions.precombat=flask,type=whispered_pact
actions.precombat+=/food,type=azshari_salad
actions.precombat+=/summon_pet,if=!talent.grimoire_of_supremacy.enabled&(!talent.grimoire_of_sacrifice.enabled|buff.demonic_power.down)
actions.precombat+=/summon_doomguard,if=talent.grimoire_of_supremacy.enabled&active_enemies<3
...
actions+=/shadowflame,if=debuff.shadowflame.stack=1&dot.shadowflame.remains<=dot.shadowflame.duration*0.3+travel_time
actions+=/shadowflame,if=debuff.shadowflame.stack=2
