...
actions=reap_souls,if=actions=reap_souls,if=!buff.deadwind_harvester.remains&(buff.soul_harvest.remains|buff.tormented_souls.react>=8|target.time_to_die<=buff.tormented_souls.react*5|trinket.proc.any.react|buff.valarjars_path.remains)
...
actions+=/potion,name=deadly_grace,if=(buff.soul_harvest.remains|trinket.proc.any.react|buff.valarjars_path.remains)
...
actions+=/unstable_affliction,if=talent.contagion.enabled|(buff.valarjars_path.remains|soul_shard>=4|trinket.proc.mastery.react|trinket.proc.crit.react|trinket.proc.versatility.react|buff.soul_harvest.remains|buff.deadwind_harvester.remains|buff.compounding_horror.react=5|target.time_to_die<=20)
...
actions+=/immolate,if=talent.roaring_blaze.enabled&debuff.roaring_blaze.stack=0
actions+=/immolate,if=!talent.roaring_blaze.enabled
actions+=/incinerate
actions+=/life_tap
]]
