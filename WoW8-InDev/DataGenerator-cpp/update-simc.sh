...
extract_dbcs() {
    ...
    for t in Spell.db2 SpellName.db2 SpellAuraOptions.db2 SpellCastTimes.db2 SpellCastingRequirements.db2 SpellCategory.db2 SpellCategories.db2 SpellClassOptions.db2 SpellCooldowns.db2 SpellDuration.db2 SpellMisc.db2 SpellEquippedItems.db2 SpellLabel.db2 SpellLevels.db2 SpellMechanic.db2 SpellPower.db2 SpellRadius.db2 SpellRange.db2 SpellTargetRestrictions.db2 SpellXDescriptionVariables.db2 SpellItemEnchantment.db2 ChrSpecialization.db2 SpecializationSpells.db2 Item.db2 ItemSparse.db2 ItemSet.db2 ItemSetSpell.db2 SkillLine.db2 SkillLineAbility.db2 Talent.db2 ; do # SpellEffect.db2 SpellEffectAutoDescription.db2
        python3 dbc_extract.py  --path "$casc_output_dir/DBFilesClient" --build $build_version --type csv $t > "$script_dir/$(basename $t .db2).csv" || true
    done
