...
actions.main+=/mindbender,if=!set_bonus.tier20_4pc&(talent.mindbender.enabled&((talent.surrender_to_madness.enabled&target.time_to_die>variable.s2mcheck+60)|!talent.surrender_to_madness.enabled))
...
actions.vf+=/dispersion,if=talent.legacy_of_the_void.enabled&current_insanity_drain*gcd.max>insanity&!buff.power_infusion.up&buff.voidform.stack>=51&cooldown.void_torrent.remains<=8
...
actions.vf+=/mindbender,if=set_bonus.tier20_4pc&buff.insanity_drain_stacks.value>=(25+2*buff.bloodlust.up+2*talent.fortress_of_the_mind.enabled)&(!talent.surrender_to_madness.enabled|(talent.surrender_to_madness.enabled&target.time_to_die>variable.s2mcheck-buff.insanity_drain_stacks.value))
actions.vf+=/mindbender,if=!set_bonus.tier20_4pc&(!talent.surrender_to_madness.enabled|(talent.surrender_to_madness.enabled&target.time_to_die>variable.s2mcheck-(buff.insanity_drain_stacks.value)+30))
