...
actions.ptr_aoe=stormkeeper
actions.ptr_aoe+=/ascendance
actions.ptr_aoe+=/liquid_magma_totem
actions.ptr_aoe+=/flame_shock,if=spell_targets.chain_lightning<4&maelstrom>=20,target_if=refreshable
actions.ptr_aoe+=/earthquake
actions.ptr_aoe+=/lava_burst,if=dot.flame_shock.remains>cast_time&buff.lava_surge.up&!talent.lightning_rod.enabled&spell_targets.chain_lightning<4
actions.ptr_aoe+=/elemental_blast,if=!talent.lightning_rod.enabled&spell_targets.chain_lightning<5|talent.lightning_rod.enabled&spell_targets.chain_lightning<4
actions.ptr_aoe+=/lava_beam
actions.ptr_aoe+=/chain_lightning,target_if=debuff.lightning_rod.down
actions.ptr_aoe+=/chain_lightning
actions.ptr_aoe+=/lava_burst,moving=1
actions.ptr_aoe+=/flame_shock,moving=1,target_if=refreshable
actions.ptr_default=totem_mastery,if=buff.resonance_totem.remains<2
actions.ptr_default+=/fire_elemental,if=talent.primal_elementalist.enabled|!pet.primal_fire_elemental.active
actions.ptr_default+=/storm_elemental,if=talent.primal_elementalist.enabled|!pet.primal_storm_elemental.active
actions.ptr_default+=/elemental_mastery
actions.ptr_default+=/use_item,name=gnawed_thumb_ring,if=equipped.gnawed_thumb_ring&(talent.ascendance.enabled&!buff.ascendance.up|!talent.ascendance.enabled)
actions.ptr_default+=/blood_fury,if=!talent.ascendance.enabled|buff.ascendance.up|cooldown.ascendance.remains>50
actions.ptr_default+=/berserking,if=!talent.ascendance.enabled|buff.ascendance.up
actions.ptr_default+=/run_action_list,name=ptr_aoe,if=active_enemies>2&(spell_targets.chain_lightning>2|spell_targets.lava_beam>2)
actions.ptr_default+=/run_action_list,name=ptr_single_asc,if=talent.ascendance.enabled
actions.ptr_default+=/run_action_list,name=ptr_single_if,if=talent.icefury.enabled
actions.ptr_default+=/run_action_list,name=ptr_single_lr,if=talent.lightning_rod.enabled
...
actions.ptr_single_if=flame_shock,if=!ticking|dot.flame_shock.remains<=gcd
actions.ptr_single_if+=/earthquake,if=buff.echoes_of_the_great_sundering.up&maelstrom>=86
actions.ptr_single_if+=/frost_shock,if=buff.icefury.up&maelstrom>=111
actions.ptr_single_if+=/earth_shock,if=maelstrom>=117|!artifact.swelling_maelstrom.enabled&maelstrom>=92
actions.ptr_single_if+=/stormkeeper,if=raid_event.adds.count<3|raid_event.adds.in>50
actions.ptr_single_if+=/elemental_blast
actions.ptr_single_if+=/icefury,if=raid_event.movement.in<5|maelstrom<=101
actions.ptr_single_if+=/liquid_magma_totem,if=raid_event.adds.count<3|raid_event.adds.in>50
actions.ptr_single_if+=/lightning_bolt,if=buff.power_of_the_maelstrom.up&buff.stormkeeper.up&spell_targets.chain_lightning<3
actions.ptr_single_if+=/lava_burst,if=dot.flame_shock.remains>cast_time&cooldown_react
actions.ptr_single_if+=/frost_shock,if=buff.icefury.up&((maelstrom>=20&raid_event.movement.in>buff.icefury.remains)|buff.icefury.remains<(1.5*spell_haste*buff.icefury.stack+1))
actions.ptr_single_if+=/flame_shock,if=maelstrom>=20&buff.elemental_focus.up,target_if=refreshable
actions.ptr_single_if+=/frost_shock,moving=1,if=buff.icefury.up
actions.ptr_single_if+=/earth_shock,if=maelstrom>=111|!artifact.swelling_maelstrom.enabled&maelstrom>=86
actions.ptr_single_if+=/totem_mastery,if=buff.resonance_totem.remains<10
actions.ptr_single_if+=/earthquake,if=buff.echoes_of_the_great_sundering.up
actions.ptr_single_if+=/lightning_bolt,if=buff.power_of_the_maelstrom.up&spell_targets.chain_lightning<3
actions.ptr_single_if+=/chain_lightning,if=active_enemies>1&spell_targets.chain_lightning>1
actions.ptr_single_if+=/lightning_bolt
actions.ptr_single_if+=/flame_shock,moving=1,target_if=refreshable
actions.ptr_single_if+=/earth_shock,moving=1
actions.ptr_single_if+=/flame_shock,moving=1,if=movement.distance>6
actions.ptr_single_lr=flame_shock,if=!ticking|dot.flame_shock.remains<=gcd
actions.ptr_single_lr+=/earthquake,if=buff.echoes_of_the_great_sundering.up&maelstrom>=86
actions.ptr_single_lr+=/earth_shock,if=maelstrom>=117|!artifact.swelling_maelstrom.enabled&maelstrom>=92
actions.ptr_single_lr+=/stormkeeper,if=raid_event.adds.count<3|raid_event.adds.in>50
actions.ptr_single_lr+=/elemental_blast
actions.ptr_single_lr+=/liquid_magma_totem,if=raid_event.adds.count<3|raid_event.adds.in>50
actions.ptr_single_lr+=/lava_burst,if=dot.flame_shock.remains>cast_time&cooldown_react
actions.ptr_single_lr+=/flame_shock,if=maelstrom>=20&buff.elemental_focus.up,target_if=refreshable
actions.ptr_single_lr+=/earth_shock,if=maelstrom>=111|!artifact.swelling_maelstrom.enabled&maelstrom>=86
actions.ptr_single_lr+=/totem_mastery,if=buff.resonance_totem.remains<10|(buff.resonance_totem.remains<(buff.ascendance.duration+cooldown.ascendance.remains)&cooldown.ascendance.remains<15)
actions.ptr_single_lr+=/earthquake,if=buff.echoes_of_the_great_sundering.up
actions.ptr_single_lr+=/lightning_bolt,if=buff.power_of_the_maelstrom.up&spell_targets.chain_lightning<3,target_if=debuff.lightning_rod.down
actions.ptr_single_lr+=/lightning_bolt,if=buff.power_of_the_maelstrom.up&spell_targets.chain_lightning<3
actions.ptr_single_lr+=/chain_lightning,if=active_enemies>1&spell_targets.chain_lightning>1,target_if=debuff.lightning_rod.down
actions.ptr_single_lr+=/chain_lightning,if=active_enemies>1&spell_targets.chain_lightning>1
actions.ptr_single_lr+=/lightning_bolt,target_if=debuff.lightning_rod.down
actions.ptr_single_lr+=/lightning_bolt
actions.ptr_single_lr+=/flame_shock,moving=1,target_if=refreshable
actions.ptr_single_lr+=/earth_shock,moving=1
actions.ptr_single_lr+=/flame_shock,moving=1,if=movement.distance>6
