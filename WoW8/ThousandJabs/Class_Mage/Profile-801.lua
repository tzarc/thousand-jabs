...
local frost_abilities_exported = {
    arcane_intellect = { SpellIDs = { 1459 }, },
    blink = { SpellIDs = { 1953 }, },
    blizzard = { SpellIDs = { 190356 }, },
    bone_chilling = { TalentID = 22457, },
    brain_freeze = { SpellIDs = { 190447 }, },
    chain_reaction = { TalentID = 22466, },
    cold_snap = { SpellIDs = { 235219 }, },
    comet_storm = { SpellIDs = { 153595 }, TalentID = 22473, },
    cone_of_cold = { SpellIDs = { 120 }, },
    conjure_refreshment = { SpellIDs = { 190336 }, },
    counterspell = { SpellIDs = { 2139 }, },
    ebonbolt = { SpellIDs = { 257537 }, TalentID = 22469, },
    fingers_of_frost = { SpellIDs = { 112965 }, },
    flurry = { SpellIDs = { 44614 }, },
    freeze = { SpellIDs = { 33395 }, },
    freezing_rain = { TalentID = 22454, },
    frigid_winds = { TalentID = 22446, },
    frost_nova = { SpellIDs = { 122 }, },
    frostbolt = { SpellIDs = { 116 }, },
    frozen_orb = { SpellIDs = { 84714 }, },
    frozen_touch = { TalentID = 22452, },
    glacial_insulation = { TalentID = 22442, },
    glacial_spike = { SpellIDs = { 199786 }, TalentID = 21634, },
    ice_barrier = { SpellIDs = { 11426 }, },
    ice_block = { SpellIDs = { 45438 }, },
    ice_floes = { SpellIDs = { 108839 }, TalentID = 23073, },
    ice_lance = { SpellIDs = { 30455 }, },
    ice_nova = { SpellIDs = { 157997 }, TalentID = 22463, },
    ice_ward = { TalentID = 22448, },
    icy_veins = { SpellIDs = { 12472 }, },
    incanters_flow = { TalentID = 22444, },
    invisibility = { SpellIDs = { 66 }, },
    lonely_winter = { TalentID = 22460, },
    mastery_icicles = { SpellIDs = { 76613 }, },
    mirror_image = { SpellIDs = { 55342 }, TalentID = 22445, },
    polymorph = { SpellIDs = { 118 }, },
    ray_of_frost = { SpellIDs = { 205021 }, TalentID = 22309, },
    remove_curse = { SpellIDs = { 475 }, },
    ring_of_frost = { SpellIDs = { 113724 }, TalentID = 22471, },
    rune_of_power = { SpellIDs = { 116011 }, TalentID = 22447, },
    shatter = { SpellIDs = { 12982 }, },
    shimmer = { SpellIDs = { 212653 }, TalentID = 22443, },
    slow_fall = { SpellIDs = { 130 }, },
    spellsteal = { SpellIDs = { 30449 }, },
    splitting_ice = { TalentID = 23176, },
...
local frost_base_abilities = {
    ...
    arcane_intellect = {
        ...
        AuraUnit = 'player',
        AuraMine = true,
        AuraApplied = 'arcane_intellect',
        AuraApplyLength = 3600,
        CanCast = function(spell,env)
            return spell.aura_down
        end
    },
    fingers_of_frost = {
        AuraID = { 44544, 112965 },
