...
local blood_abilities_exported = {
    antimagic_barrier = { TalentID = 22014, },
    antimagic_shell = { SpellIDs = { 48707 }, },
    asphyxiate = { SpellIDs = { 221562 }, },
    blood_boil = { SpellIDs = { 50842 }, },
    blooddrinker = { SpellIDs = { 206931 }, TalentID = 19166, },
    bloodworms = { TalentID = 19231, },
    bonestorm = { SpellIDs = { 194844 }, TalentID = 21209, },
    consumption = { SpellIDs = { 274156 }, TalentID = 19220, },
    ...
    deaths_advance = { SpellIDs = { 48265 }, },
    deaths_caress = { SpellIDs = { 195292 }, },
    foul_bulwark = { TalentID = 19221, },
    gorefiends_grasp = { SpellIDs = { 108199 }, },
    grip_of_the_dead = { TalentID = 19227, },
    heart_strike = { SpellIDs = { 206930 }, },
    heartbreaker = { TalentID = 19165, },
    hemostasis = { TalentID = 19219, },
    icebound_fortitude = { SpellIDs = { 48792 }, },
    mark_of_blood = { SpellIDs = { 206940 }, TalentID = 19232, },
    marrowrend = { SpellIDs = { 195182 }, },
    mastery_blood_shield = { SpellIDs = { 77513 }, },
    mind_freeze = { SpellIDs = { 47528 }, },
    on_a_pale_horse = { SpellIDs = { 51986 }, },
    ossuary = { TalentID = 22134, },
    path_of_frost = { SpellIDs = { 3714 }, },
    purgatory = { TalentID = 21207, },
    raise_ally = { SpellIDs = { 61999 }, },
    rapid_decomposition = { TalentID = 19218, },
    red_thirst = { TalentID = 21208, },
    rune_strike = { SpellIDs = { 210764 }, TalentID = 19217, },
    rune_tap = { SpellIDs = { 194679 }, TalentID = 22015, },
    runeforging = { SpellIDs = { 53428 }, },
    tightening_grasp = { TalentID = 19226, },
    tombstone = { SpellIDs = { 219809 }, TalentID = 22135, },
    vampiric_blood = { SpellIDs = { 55233 }, },
    veteran_of_the_third_war = { SpellIDs = { 48263 }, },
    voracious = { TalentID = 19230, },
    will_of_the_necropolis = { TalentID = 22013, },
    wraith_walk = { SpellIDs = { 212552 }, TalentID = 19228, },
}
...
local unholy_abilities_exported = {
    all_will_serve = { TalentID = 22025, },
    antimagic_shell = { SpellIDs = { 48707 }, },
    apocalypse = { SpellIDs = { 275699 }, },
    army_of_the_damned = { TalentID = 22030, },
    army_of_the_dead = { SpellIDs = { 42650 }, },
    asphyxiate = { SpellIDs = { 108194 }, TalentID = 22520, },
    bursting_sores = { TalentID = 22027, },
    chains_of_ice = { SpellIDs = { 45524 }, },
    claw = { SpellIDs = { 47468 }, },
    clawing_shadows = { SpellIDs = { 207311 }, TalentID = 22026, },
    control_undead = { SpellIDs = { 111673 }, },
    dark_command = { SpellIDs = { 56222 }, },
    ...
    death_gate = { SpellIDs = { 50977 }, },
    death_grip = { SpellIDs = { 49576 }, },
    death_pact = { SpellIDs = { 48743 }, TalentID = 23373, },
    death_strike = { SpellIDs = { 49998 }, },
    deaths_advance = { SpellIDs = { 48265 }, },
    deaths_reach = { TalentID = 22518, },
    defile = { SpellIDs = { 152280 }, TalentID = 22534, },
    ebon_fever = { TalentID = 22028, },
    epidemic = { SpellIDs = { 207317 }, TalentID = 22536, },
    festering_strike = { SpellIDs = { 85948 }, },
    gnaw = { SpellIDs = { 47481 }, },
    grip_of_the_dead = { TalentID = 22516, },
    harbinger_of_doom = { TalentID = 22524, },
    huddle = { SpellIDs = { 47484 }, },
    icebound_fortitude = { SpellIDs = { 48792 }, },
    infected_claws = { TalentID = 22024, },
    leap = { SpellIDs = { 47482 }, },
    ...
    path_of_frost = { SpellIDs = { 3714 }, },
    pestilence = { TalentID = 22532, },
    pestilent_pustules = { TalentID = 22522, },
    raise_ally = { SpellIDs = { 61999 }, },
    raise_dead = { SpellIDs = { 46584 }, },
    runeforging = { SpellIDs = { 53428 }, },
    runic_corruption = { SpellIDs = { 51462 }, },
    scourge_strike = { SpellIDs = { 55090 }, },
    soul_reaper = { SpellIDs = { 130736 }, TalentID = 22526, },
    spell_eater = { TalentID = 22528, },
    sudden_doom = { SpellIDs = { 49530 }, },
    summon_gargoyle = { SpellIDs = { 49206 }, TalentID = 22538, },
    unholy_blight = { SpellIDs = { 115989 }, TalentID = 22029, },
    unholy_frenzy = { SpellIDs = { 207289 }, TalentID = 22110, },
    wraith_walk = { SpellIDs = { 212552 }, TalentID = 22529, },
}
...
local frost_abilities_exported = {
    antimagic_shell = { SpellIDs = { 48707 }, },
    asphyxiate = { SpellIDs = { 108194 }, TalentID = 22517, },
    avalanche = { TalentID = 22521, },
    blinding_sleet = { SpellIDs = { 207167 }, TalentID = 22519, },
    breath_of_sindragosa = { SpellIDs = { 152279 }, TalentID = 22537, },
    chains_of_ice = { SpellIDs = { 45524 }, },
    cold_heart = { TalentID = 22018, },
    control_undead = { SpellIDs = { 111673 }, },
    dark_command = { SpellIDs = { 56222 }, },
    dark_succor = { SpellIDs = { 178819 }, },
    death_gate = { SpellIDs = { 50977 }, },
    ...
    death_strike = { SpellIDs = { 49998 }, },
    deaths_advance = { SpellIDs = { 48265 }, },
    deaths_reach = { TalentID = 22515, },
    empower_rune_weapon = { SpellIDs = { 47568 }, },
    frost_strike = { SpellIDs = { 49143 }, },
    frostscythe = { SpellIDs = { 207230 }, TalentID = 22525, },
    frostwyrms_fury = { SpellIDs = { 279302 }, TalentID = 22535, },
    frozen_pulse = { TalentID = 22523, },
    gathering_storm = { TalentID = 22531, },
    glacial_advance = { SpellIDs = { 194913 }, TalentID = 22533, },
    horn_of_winter = { SpellIDs = { 57330 }, TalentID = 22021, },
    howling_blast = { SpellIDs = { 49184 }, },
    icebound_fortitude = { SpellIDs = { 48792 }, },
    icecap = { TalentID = 22023, },
    icy_talons = { TalentID = 22017, },
    inexorable_assault = { TalentID = 22016, },
    ...
    obliteration = { SpellIDs = { 281238 }, TalentID = 22109, },
    on_a_pale_horse = { SpellIDs = { 51986 }, },
    path_of_frost = { SpellIDs = { 3714 }, },
    permafrost = { TalentID = 22527, },
    pillar_of_frost = { SpellIDs = { 51271 }, },
    raise_ally = { SpellIDs = { 61999 }, },
    remorseless_winter = { SpellIDs = { 196770 }, },
    rime = { SpellIDs = { 59057 }, },
    runeforging = { SpellIDs = { 53428 }, },
    runic_attenuation = { TalentID = 22019, },
    runic_empowerment = { SpellIDs = { 81229 }, },
    wraith_walk = { SpellIDs = { 212552 }, TalentID = 22530, },
}
