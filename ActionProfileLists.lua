...
actions.single+=/flame_shock,cycle_targets=1,if=(talent.elemental_fusion.enabled&buff.elemental_fusion.stack=2&buff.unleash_flame.up&dot.flame_shock.remains<(dot.flame_shock.duration*(0.3+t18_class_trinket*0.65)))
...
actions.single+=/flame_shock,cycle_targets=1,if=dot.flame_shock.remains<=9
...
actions.single+=/elemental_blast,if=buff.maelstrom_weapon.react>=5+4*set_bonus.tier18_4pc
...
actions.single+=/lightning_bolt,if=buff.maelstrom_weapon.react>=5+4*set_bonus.tier18_4pc
...
actions.single+=/lightning_bolt,if=(!set_bonus.tier18_4pc&(buff.maelstrom_weapon.react>=1&!buff.ascendance.up))|(set_bonus.tier18_4pc&buff.maelstrom_weapon.react>=7)|buff.ancestral_swiftness.up
...
actions.db+=/life_tap
actions.db_meta=immolation_aura,if=demonic_fury>450&active_enemies>=5&buff.immolation_aura.down
actions.db_meta+=/doom,cycle_targets=1,if=active_enemies>=6&target.time_to_die>=30*spell_haste&remains-gcd<=(duration*0.3)&(buff.dark_soul.down|!glyph.dark_soul.enabled)
...
actions.db_meta+=/chaos_wave,if=buff.dark_soul.up&active_enemies>=2&demonic_fury>450
...
actions.meta+=/cataclysm
actions.meta+=/immolation_aura,if=demonic_fury>450&active_enemies>=3&buff.immolation_aura.down
...
actions.meta+=/chaos_wave,if=buff.dark_soul.up&active_enemies>=2|(charges=3|set_bonus.tier17_4pc=0&charges=2)
...
actions.meta+=/soul_fire,if=buff.molten_core.react&(buff.demon_rush.remains<=4|buff.demon_rush.stack<5)&set_bonus.tier18_2pc=1
...
actions.aoe+=/rend,cycle_targets=1,if=ticks_remain<2&target.time_to_die-remains>18&!buff.colossus_smash_up.up&spell_targets.whirlwind<=8
...
actions.aoe+=/mortal_strike,if=target.health.pct>20&spell_targets.whirlwind<=5
...
actions.aoe+=/rend,cycle_targets=1,if=ticks_remain<2&target.time_to_die>8&!buff.colossus_smash_up.up&spell_targets.whirlwind>=9&rage<50&!talent.taste_for_blood.enabled
