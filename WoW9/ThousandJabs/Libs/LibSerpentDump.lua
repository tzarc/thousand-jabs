	...
	local function val2str(t, name, indent, insref, path, plainindex, level)
		...
		if
			type(mt) == "table" and
				...
				(mt.__serialize or mt.__tostring)
		...
		elseif ttype == "function" then
			...
			local func =
				ok and
				((opts.nocode and "function() --[[..skipped..]] end" or
...
--[[--------------------------------------------------------------------------------------------------------------------------------------------------------]] local function dump(
	value)
	return s(value, merge({compact = false, sortkeys = true, indent = "  ", sparse = true, nocode = true}, opts))
end
